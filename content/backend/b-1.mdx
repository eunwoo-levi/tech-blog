...
categoryId: 8
keywords: ['NestJS', 'RAG', 'AI API', 'LLM', 'GPT', '응급처치', 'Vector DB', '코사인 유사도']
description: 'NestJS로 RAG 기반 AI API를 구현한 경험을 공유합니다. LLM의 답변 생성 방식과 RAG의 필요성, 전체 아키텍처 설계, 각 서비스의 역할 분담, 프롬프트 조립 방법 등을 자세히 설명합니다.'
---
