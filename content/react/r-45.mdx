...
categoryId: 6
keywords: ['Webpack', '번들 최적화', 'Code Splitting', '트리셰이킹']
description: ' Webpack 설정을 최적화하여 빌드 속도를 개선하는 방법에 대해 다룹니다. 초기 로딩 책임 분리, Route 기반 Code Splitting, 번들 구조 재설계, 트리셰이킹 활성화, Minify + Gzip 적용 등 다양한 전략을 통해 성능을 향상시키는 과정을 설명합니다.'
---
