  ...
  return (
    <section className='px-6 py-20'>
      <div className='mx-auto max-w-4xl'>
        ...
        <p className='mb-8 text-base text-zinc-500'>{tr.contact.subtitle}</p>
        <div className='flex flex-wrap gap-3'>
          ...
          <a
            ...
            className='inline-flex items-center gap-2 rounded-lg border border-zinc-800 px-5 py-2.5 text-base font-medium text-zinc-400 transition-colors hover:border-zinc-600 hover:text-zinc-200'
          >
