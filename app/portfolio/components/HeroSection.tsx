  ...
  return (
    <section className='relative overflow-hidden border-b border-zinc-800 px-6 py-24 sm:py-32'>
      ...
      <div className='relative mx-auto max-w-4xl'>
        <p
          className='mb-3 text-sm font-medium uppercase tracking-widest text-zinc-400'
          style={fu(0.1)}
        >
          Frontend Engineer
        </p>
        ...
        <p className='mt-5 text-lg leading-relaxed text-zinc-300' style={fu(0.4)}>
          {tr.hero.desc1}
        </p>
        <p className='mt-2 text-lg text-zinc-400' style={fu(0.52)}>
          {tr.hero.desc2}
        </p>
        <p className='mt-2 text-lg text-zinc-400' style={fu(0.62)}>
          {tr.hero.desc3}
        </p>
        <div
          className='mt-7 flex flex-wrap items-center gap-x-6 gap-y-2 text-base text-zinc-400'
          style={fu(0.64)}
        >
